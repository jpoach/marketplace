...
parser.add_argument("--min-price", type=int, default=1750, help="Minimum price of the car")
...
parser.add_argument("--search", type=str, default="Ford%20Escape", help="Search")
