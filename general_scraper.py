...
parser.add_argument("--days-listed", type=int, default=2, help="Maximum number of days the item has been listed")
parser.add_argument("--radius", type=int, default=80, help="Search radius")
